...
function App({setUser}) {  
  ...
  return (
    <main className="flex flex-row h-screen sm:flex-col md:flex-row">
      ...
      <section className={`flex flex-col items-center justify-center bg-atvGradient w-[50%] absolute h-screen transition-all duration-500 ${left}`}>
        ...
        <Paragraph styles="text-complementary-white mt-[60px]">A plataforma eficiente para gerenciar e acompanhar todos os recursos da escola SENAI Informática</Paragraph>
